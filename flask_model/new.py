...
class ViolenceDetectionUI:
    def __init__(self, window):
        ...
        self.violence_model = load_model(r'F:\flask_model\model_v_nv\model.h5')
        ...
        # Get initial location before setting up UI
    ...
    def initialize_location(self):
        ...
        g = geocoder.ip('me')
        if g.ok:
            self.current_coords = g.latlng
            self.current_address = g.address
        else:
            self.current_coords = None
            self.current_address = "Location unavailable"
    ...
    def setup_ui(self):
        ...
        self.location_label = ttk.Label(control_frame,
                                      text=f"Current Location: {self.current_address}",
                                      style='Main.TLabel',
                                      font=('Helvetica', 10))
        ...
        # Initialize map with stored location
